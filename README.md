...
- **크롬 확장 프로그램**을 통한 **실시간 방문 페이지 제목 및 체류 시간** 데이터 수집
- **OpenAI GPT-4 API 연동**을 통한 **일일 활동 요약 및 핵심 키워드 자동 추출**

### 2. 개인화 회고 리포트 및 통계📈
- **월별 캘린더**: 한 달간의 회고 기록을 **캘린더 형식으로 시각화**하여 활동 흐름 파악
- **사용 시간 통계**: **카테고리별 시간 점유율을 계산**하여 도넛 차트 형태의 리포트 제공
